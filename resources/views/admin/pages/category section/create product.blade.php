...
@section('content')
    <form action="{{route('admin.category_section.search')}}" method="get" id="search">@csrf</form>
    <form action="{{route('admin.category_section.storeProduct')}}" id="formCreate" method="post">
        <div class="card">
            <div class="card-header">
                <div class="d-flex align-items-center justify-content-between w-100">
                    <div class="w-100">
                        <input type="search" form="search" name="string" class="form-control w-25" placeholder="Name - Id">
                        <button type="submit" form="search" class="btn btn-primary mt-1">Search</button>
                    </div>
