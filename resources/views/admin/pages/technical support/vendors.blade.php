...
@section('main-header', 'Vendors')
@section('header', 'Technical Support')
@section('title_header', 'Vendors')
@section('content')
    <!-- Row -->
    <div class="row row-sm">
        <div class="col-lg-12">
            <div class="card">
                ...
                <form action="{{route('admin.technical_support.search_vendors')}}" method="post">
                    @csrf
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover text-nowrap border-bottom"
                                   id="basic-datatable">
                                <tr>
