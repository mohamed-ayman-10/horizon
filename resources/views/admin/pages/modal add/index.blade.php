...
@section('title', 'Modal Ads')
@section('main-header', 'Modal Ads')
@section('title_header', 'Modal Ads')
@section('header', 'Ads')
@section('content')
    <div class="card">
                    ...
                    <div class="modal fade" id="update{{$item->id}}">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{ route('admin.ads.modal.update', $item->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                    ...
                    <div class="modal fade" id="delete{{$item->id}}">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <form action="{{ route('admin.ads.modal.destroy', $item->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <div class="modal-body">
    ...
    <div class="modal fade" id="create">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('admin.ads.modal.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="form-label">
