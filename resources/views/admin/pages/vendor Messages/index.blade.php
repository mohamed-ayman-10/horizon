                            ...
                            <thead>
                                <tr>
                                    <th class="text-center">
                                        <input class="headerCheckbox" id="example-select-all"
                                        ...
                                        <td>
                                            <div class="">
                                                ...
                                                <a class="btn btn-warning"
                                                    href="{{ route('admin.vendorMessage.show', $item->id) }}"><i
                                                        class="fe fe-eye"></i></a>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="modal fade" id="send_all">
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('admin.vendorMessage.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
