...
@section('title', 'Last Category')
@section('main-header', 'Last Category')
@section('header', 'Sections')
@section('title_header', 'Last Category')
@section('content')
    <!-- Row -->
    ...
    <div class="modal fade" id="fullscreenmodal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.section.lastCategory.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
