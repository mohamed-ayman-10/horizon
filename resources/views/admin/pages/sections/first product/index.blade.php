...
@section('title', 'First Product')
@section('main-header', 'First Product')
@section('header', 'Sections')
@section('title_header', 'First Product')
@section('content')
    <!-- Row -->
    ...
    <div class="modal fade" id="fullscreenmodal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.section.firstProduct.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
