...
@section('main-header', 'Weekly Offers')
@section('header', 'Sections')
@section('title_header', 'Weekly Offers')
@section('content')
    <!-- Row -->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-danger" title="Delete" data-bs-toggle="modal"
                                                data-bs-target="#deleteImage{{ $item->id }}"" href="javascript:void(0)">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content modal-content-demo">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="{{ route('admin.section.weeklyOffer.destroy', $item->id) }}"
    ...
    <div class="modal fade" id="fullscreenmodal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-fullscreen" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.section.weeklyOffer.store') }}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
